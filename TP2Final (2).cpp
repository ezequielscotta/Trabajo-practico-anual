...
int Menu(void){
	...
	do{
			system("CLS");
			cout<<"\n\n\t\t -------------- MENU --------------";//NICO
			cout<<"\n\t\t 1 - Levantar Usuarios.";//SANTI/NICO
			cout<<"\n\t\t 2 - Cargar Nuevo Usuario.";//NICO
			cout<<"\n\t\t 3 - Actividad De Un Usuario.";//NICO
			cout<<"\n\t\t 4 - Buscar Usuario.";//NICO
			cout<<"\n\t\t 5 - Listar Usuarios.";//NICO
			cout<<"\n\t\t 6 - Procesar Un Lote De Compras.";//SANTI/NICO
			cout<<"\n\t\t 7 - Mostrar Compras Realizadas Por Un Usuario.";//NICO
			cout<<"\n\t\t 8 - Mostrar todas las compras realizadas entre dos fechas \
					\n\t\t    en un reporte escrito en formato html y el total de las compras.";//EZE30%/NICO30% ------------------------------------- FUNCIONA ---------- FALTAPULIR
			cout<<"\n\t\t 9 - Mostrar todas las compras realizadas entre dos fechas \
					\n\t\t    en un reporte escrito en formato CSV y el total de las compras.";//Eze --NO FUNCIONA--NO FUNCIONA--NO FUNCIONA--NO FUNCIONA--NO FUNCIONA--NO FUNCIONA--NO FUNCIONA--NO FUNCIONA
			cout<<"\n\t\t Q - Finalizar Jornada.";
			cout<<"\n\n\t\t Su eleccion es: ";
			Eleccion=getch();	
